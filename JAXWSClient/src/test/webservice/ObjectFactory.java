...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://webservice.test/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://webservice.test/", "helloWorldResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.test/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.test/", name = "helloWorldResponse")
